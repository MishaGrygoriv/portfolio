<template>
  <div class="js-progress" @mouseover="changeState" @mouseout="originalState">
    <vue-ellipse-progress
      class="js-progress__circle"
      :progress="progress"
      :emptyColorFill="emptyColorFill"
      v-bind="options"
    >
      <span class="js-progress__value" slot="legend-value">%</span>
      <p class="js-progress__caption" slot="legend-caption">JS SKILLS</p>
    </vue-ellipse-progress>
  </div>
</template>
<script>
