<template>
  <div class="html-progress" @mouseover="changeState" @mouseout="originalState">
    <vue-ellipse-progress
      class="html-progress__circle"
      :progress="progress"
      :emptyColorFill="emptyColorFill"
      v-bind="options"
    >
      <span class="html-progress__value" slot="legend-value">%</span>
      <p class="html-progress__caption" slot="legend-caption">HTML SKILLS</p>
    </vue-ellipse-progress>
  </div>
</template>
<script>
